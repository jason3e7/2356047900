...
* 村里有三個神秘的河內塔，最近發現在塔樓周圍散落著一些謎題。
* 為了解決這個難題，你需要找到一個有效的方法來移動磁盤狀態到最終狀態。
* 你能解決這些難題嗎?
...
* 試著猜我的號碼。
* 不要擔心你的號碼被一些駭客竊取，你可以用AES加密發送號碼。
* 前幾天我給了你鑰匙，對嗎？
* 或者我沒有？沒關係，我想你會想東西了。

* nc 140.110.112.29 5121

* [server.py-69ea0baf6d714dffb14251d37402846f2830d5b5](PPC/blindBinarySearch/server.py-69ea0baf6d714dffb14251d37402846f2830d5b5)

Note:
* 先熟悉 aes 的加解密, 並撰寫程式, 但是不知道怎麼猜.
